...
;
; App Icon: Updated with new branding
;   - Design: Blue circular background (#00BCD4 Cyan) with white "J" shape
;   - Size: 256x256 pixels
;   - Format: Windows ICO format
;   - Generated by: create_icon.py + convert_to_ico.py
...
WizardStyle=modern
; Updated app icon - Blue circular with white J shape (256x256)
...
; Application Icon (New: Blue circular with white J shape)
...
; Updated icons with new app branding (Blue circular with white J)
[Icons]
